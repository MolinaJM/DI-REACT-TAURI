...
### 📦 AuthProvider.tsx (repos/04-react-avanzado/src/context/)
...
### 📦 carritoStore.ts (repos/04-react-avanzado/src/store/)
...
### 📦 AppRouter.tsx (repos/04-react-avanzado/src/routing/)
...
### 📦 RouterSPA.ts (repos/04-react-avanzado/src/routing/)
...
### 📦 AlmacenPersistente.ts (repos/04-react-avanzado/src/components/)
...
## Código real: repositorio 02 (React componentes)

### 📦 localStorage.ts (repos/02-react-componentes/src/state/)
...
### 📦 useReducerEjemplo.tsx (repos/02-react-componentes/src/state/)
...
### 📦 FormularioRegistro.tsx (repos/02-react-componentes/src/state/)
