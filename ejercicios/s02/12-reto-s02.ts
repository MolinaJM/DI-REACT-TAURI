...
function panelEstado(estado: EstadoMaquina): string {
...
type Moneda = 1 | 2 | 5 | 10;
function esMoneda(valor: number): valor is Moneda {
  // TODO: true solo para 1, 2, 5 o 10
  return false;
}

// 3) Total con descuento: parámetro por defecto, `for...of`, ternario
function calcularTotal(precios: number[], descuentoCentimos = 0): number {
...
function crearMaquina(productos: Producto[]): Maquina {
