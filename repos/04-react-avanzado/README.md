...
![Router](https://img.shields.io/badge/React--Router-v7-CA4245?logo=reactrouter&logoColor=white)
...
Proyecto Vite + React con Context API, Zustand, React Router v7, servicio CRUD generico, estilos con Tailwind CSS y generacion de PDF.
...
├── src/
│   ├── context/
│   │   └── AuthProvider.tsx        S08 - Context + useState (auth)
│   ├── store/
│   │   └── carritoStore.ts         S08 - Zustand store con persist
│   ├── routing/
│   │   ├── AppRouter.tsx           S08 - React Router v7
